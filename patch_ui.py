...
target_escaped = re.escape(target).replace(r'--', r'--')
target_escaped_1 = target.replace('--', '-')
target_escaped_2 = target

content = content.replace(target_escaped_1, replacement)
content = content.replace(target_escaped_2, replacement)
